            ...
            child: SingleChildScrollView(
              ...
              child: DataTable(
                ...
                columns: const [
                  ...
                  DataColumn(label: Text('Training type')),
  ...
  DataRow _catRow(int no, String name, String type, Color bg, Color fg, String desc, String subs) {
    return DataRow(
      cells: [
        ...
        DataCell(SizedBox(width: 200, child: Text(desc, maxLines: 1, overflow: TextOverflow.ellipsis))),
        DataCell(Text(subs)),
        DataCell(TextButton(onPressed: () => _toast('Edit $name'), child: const Text('Edit'))),
      ],
    );
            ...
            child: SingleChildScrollView(
              ...
              child: DataTable(
                ...
                columns: const [
                  ...
                  DataColumn(label: Text('Due within')),
            ...
            child: SingleChildScrollView(
              ...
              child: DataTable(
                ...
                columns: const [
                  ...
                  DataColumn(label: Text('Internal trainer')),
                  DataColumn(label: Text('External trainer')),
                  DataColumn(label: Text('Achieve skills')),
                  DataColumn(label: Text('Actions')),
                ],
                rows: [
                  DataRow(cells: [
                  ...
                  DataRow(cells: [
                    ...
                    const DataCell(Text('—')),
                    const DataCell(Text('Agile Acad...')),
            ...
            child: SingleChildScrollView(
              ...
              child: DataTable(
                ...
                columns: const [
                  ...
                  DataColumn(label: Text('Fee (MYR)')),
                  DataColumn(label: Text('Company cont.')),
                  DataColumn(label: Text('Request before')),
                  DataColumn(label: Text('Status')),
                ],
                rows: [
            ...
            child: SingleChildScrollView(
              ...
              child: DataTable(
                ...
                columns: const [
                  ...
                  DataColumn(label: Text('Actual date')),
